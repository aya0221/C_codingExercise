...
// double difference(BankAccount account1, BankAccount account2);  //Q19
void doubleUpdate(BankAccount& theAccount);    //Q20
...
int main(){
    ...
    // cout<<"difference:"<<difference(account1, account2);

    account1.output(cout);

    doubleUpdate(account1);
